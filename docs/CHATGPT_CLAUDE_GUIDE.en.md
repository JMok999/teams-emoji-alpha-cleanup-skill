...
```text
Read the uploaded SKILL.md and diagnose why this image cannot be returned as a downloadable Teams WebP.
...
| Python helper | Repeatable flat-background processing | High |
